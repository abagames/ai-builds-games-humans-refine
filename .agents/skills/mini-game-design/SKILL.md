...
description: "Design compact, playable game rules and controls. Use when defining a new mini-game concept, converting creative constraints into mechanics, checking state-variable necessity, or preventing idle/mashing from becoming optimal."
---
